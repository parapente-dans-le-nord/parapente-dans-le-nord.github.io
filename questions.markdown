...
### Par une belle journée d'été, la température maximum sera atteinte à (heure solaire, sans tenir compte des 2 heures d'avance sur nos montres)
...
### Indiquez les facteurs favorisant la convection :
...
### Une bulle d'air s'élève si sa température par rapport à l'air ambiant est :
...
### Les zones favorables au déclenchement de la convection sont en général :
...
### La restitution est un phénomène :
...
### Le phénomène de restitution se rencontre en général :
...
### Les signes distinctifs du Cumulonimbus et du Nimbostratus sont :
...
### On peut rencontrer des turbulences dangereuses pour le vol libre dans les phénomènes observés suivant :
...
### Pour amener une particule d'air à saturation en humidité, il faut :
...
### Parmi les nuages ci-dessous, les plus dangereux pour le vol libre sont les :
...
### Les nuages favorables aux vols de performances sont les :
...
### Parmi les nuages ci-dessous, certains produisent généralement des précipitations :
...
### Le ciel est progressivement envahi par des cirrus de plus en plus denses, puis par un voile de cirrostratus de 7/8 :
...
### Un halo autour de la lune ou du soleil est souvent :
...
### Parmi ces nuages, certains annoncent l'arrivée d'un front chaud :
...
### Le brouillard de rayonnement se forme :
...
### Le brouillard d'advection se forme :
...
### La convection dans un profil de masse d’air plutôt stable :
...
### En atmosphère humide, les ascendances :
...
### Les isobares sur une carte météo montrent :
...
### Par rapport à l'air chaud, à pression et à volumes égaux l'air froid est :
...
### Lorsqu'une particule atmosphérique non saturée s'élève sans échanger de chaleur avec l'air ambiant, sa température :
...
### Lorsqu'une particule d'air nuageux est soulevée, sa température :
...
### Dans une masse d'air sans nuages, la température est de 15°C au sol et de 12°C 500 mètres au dessus. Cette tranche d'air est :
...
### Le soleil réchauffe principalement l'atmosphère :
...
### La cause de formation des nuages, c'est :
...
### On appelle anticyclone une zone :
...
### Les anticyclones sont le siège :
...
### On appelle brise de pente descendante (ou vent catabatique) :
...
### Un vent de 20 Kt (nœuds) souffle à environ :
...
### La rotation de la terre dévie les vents vers leur :
...
### Autour des zones de haute pression, les vents tournent :
...
### Dans l'hémisphère nord lorsque vous êtes face au vent, vous avez :
...
### On appelle inversion de la température la situation suivante :
...
### Dans une atmosphère à tendance stable :
...
### Lorsque 2 masses d'air de températures différentes se rencontrent :
...
### Types de fronts possibles dans une perturbation :
...
### Les rotors et les lenticulaires semblent fixes par rapport au sol car :
...
### Lors du passage d'un front, l'air chaud :
...
### Les tendances générales d'un front froid sont :
...
### En général un front froid engendre des nuages :
...
### Lors du passage d'un front chaud :
...
### La traîne d'une perturbation, c'est la zone :
...
### La situation météo la plus favorable à la formation d'orages isolés est :
...
### Les nuages matérialisant les ondes de ressaut sont des :
...
### On risque de rencontrer une zone de cisaillement :
...
### Une confluence se rencontre habituellement :
...
### Le vent de fœhn est caractérisé par :
...
### En situation de foehn on observe :
...
### Les ondes de ressaut se rencontrent en altitude :
...
### Les ondes de ressaut se développent lorsque le vent :
...
### La formation d'onde de ressaut est favorisée par :
...
### La portance d'une aile est due à :
...
### La portance en vol rectiligne stabilisé est :
...
### En soufflerie, lorsque l'angle d'incidence augmente à partir de 0°, la portance :
...
### Sur une aile en vol rectiligne stabilisé, lorsque le pilote provoque un accroissement de l'incidence, transitoirement :
...
### Sur une aile en vol rectiligne stabilisé, lorsque le pilote provoque une diminution de l'incidence :
...
### Sur une aile en vol, il y a plusieurs types de traînées de natures bien distinctes :
...
### La traînée sur l'ensemble aile+pilote :
...
### Autour d'un profil d'aile, l'écoulement de l'air peut être :
...
### La traînée de forme de l'ensemble aile+pilote est la traînée :
...
### La traînée de profil se compose de :
...
### Parmi les points suivants, certains améliorent la finesse :
...
### L'effet girouette, c'est la conséquence d'une rotation autour de l'axe de :
...
### L'effet girouette remet l'aile :
...
### Un mouvement de lacet à droite déclenche principalement :
...
### Sur la polaire des vitesses, les régimes de vol de croisière correspondent :
...
### Un vent régulier en force et direction n'a aucune influence :
...
### Vous volez par fort vent arrière, cela implique :
...
### Vous volez à une vitesse-air de 35 km/h avec 10 km/h de vent arrière, votre vitesse-sol :
...
### En traversant une masse d'air turbulent, l'ensemble aile+pilote est soumis à des variations :
...
### Une aile en vol stabilisé dans une ascendance :
...
### Vous êtes dans une masse d'air descendante, la finesse-sol :
...
### En air calme, si l'on compare deux régimes de vol stabilisé, l'assiette :
...
### Dans un virage, l'aile s'incline principalement grâce à un mouvement de :
...
### Le poids apparent sur un appareil en virage équilibré est :
...
### Pour avancer de 4800m dans le plan horizontal, vous avez perdu 600m d'altitude ; votre finesse-sol est voisine de :
...
### On appelle charge alaire, le rapport :
...
### Si deux pilotes ont la même aile, à même incidence, le plus lourd :
...
### Pour une même aile, un fort accroissement de la charge alaire entraîne une augmentation :
...
### A surface égale, un pilote plus léger aura :
...
### Le décrochage se produit lorsque :
...
### Le décrochage a lieu en général :
...
### La portance et la traînée d'une aile sont fonctions, entre autres, de :
...
### Vous empruntez l'aile d'un pilote plus léger que vous :
...
### Vous empruntez l'aile d'un pilote plus lourd que vous :
...
### L’effet pendulaire spécifique au parapente :
...
### Le calage d'une aile de parapente :
...
### Un allongement important est facteur :
...
### Aux "oreilles", vous décidez d'utiliser l'accélérateur, cela :
...
### Le départ en vrille en parapente est précédé :
...
### Pour réduire le risque de fermeture en parapente, il faudra :
...
### Si vous volez par vent arrière fort :
...
### Juste avant le sommet d'une ressource importante :
...
### Se relever dans la sellette en finale augmente :
...
### Le variomètre de base mesure la vitesse verticale :
...
### Un parachute de secours hémisphérique est :
...
### Pour une sécurité maximale, le dépliage/repliage du parachute de secours doit être effectué :
...
### L'emport du parachute de secours :
...
### Un altimètre permet d'obtenir une information sur :
...
### Les parties de l'aile subissant le plus d'efforts en vols sont :
...
### Votre voile neuve vire systématiquement à droite, drisses de freins détendues :
...
### Des commandes réglées trop tendues :
...
### Le sticker CEN apposé sur un parapente :
...
### Le choix d'une voile est guidé par :
...
### Le container du parachute de secours :
...
### Le système de fermeture du container extérieur du parachute :
...
### Pour rendre efficace l'utilisation du parachute de secours je dois :
...
### Pour garder mon parachute en bon état, je dois :
...
### La surface d'un parapente est généralement donnée par :
...
### L'extraction du parachute de secours et le retour au sol :
...
### Un pilote breveté ayant une pratique loisir irrégulière :
...
### Une voile classée "A" aux tests de la norme CEN :
...
### Les protections dorsales et latérales de votre sellette :
...
### L'emport du parachute de secours se justifie par les risques de :
...
### La qualification d'accompagnateur fédéral :
...
### Les actions de l'accompagnateur fédéral se font auprès :
...
### L'accompagnateur fédéral utilise sa radio :
...
### Les relations entre accompagnateur fédéral et écoles de vol libre :
...
### L'accompagnateur fédéral dans un club de plaine :
...
### Quel type de plan de vol sont tenus de déposer les pratiquants de vol libre :
...
### Suis-je soumis aux mêmes règles si mon parapente ou delta est équipé d’un moteur ?
...
### Un pilote de vol libre peut-il être soumis à un contrôle d’alcoolémie ou de stupéfiants ?
...
### Quelle est l’altitude maximale absolue possible en vol libre.
...
### En espace de classe E, puis-je néanmoins croiser un trafic IFR ?
...
### Puis-je prévoir d’atterrir en delta ou parapente sur un aérodrome contrôlé ?
...
### Quelles règles dois-je respecter pour survoler une manifestation entrainant un grand rassemblement de personnes ?
...
### Comment peuvent être exprimées les limites des espaces contrôlés ?
...
### Dans quels types d’espaces militaires le pilote de l'aéronef militaire ne peut assurer l’anticollision ?
...
### Les avions de chasse de la Défense peuvent-ils évoluer en espace G et E ?
...
### Quel est le type de carte aéronautique le plus adapté pour le vol libre ?
...
### Où peut-on trouver les horaires d’activation des zones R ?
...
### Comment savoir si un exercice militaire est en cours ?
...
### Peut on voler dans les ZIT mentionnées sur les cartes aéronautiques ?
...
### A quoi correspondent les valeurs ASFC et AGL, AMSL ?
...
### Que faut-il prendre en compte pour une valeur exprimée en FL ?
...
### Comment savoir si je peux franchir une limite d’espace aérien ?
...
### Quelles indications sont portées dans le cartouche d’identification d’un espace ?
...
### Dans le cadre fédéral, la présence d'un moniteur est :
...
### Le label École Française de Vol Libre (EFVL) ou Club-École français de Vol Libre (CEFVL) :
...
### Le directeur technique d'une École Française de Vol Libre (EFVL) ou d'un Club-École Français de Vol Libre (CEFVL) :
...
### Une école non reconnue par la F.F.V.L. :
...
### Une École Française de Vol Libre (EFVL) :
...
### Un Club-École Français de Vol Libre (C.E.F.V.L) est :
...
### Avant de voler sur un site déclaré F.F.V.L. que vous ne connaissez pas, vous devez :
...
### L'assemblée générale d'une association loi 1901 affiliée à la F.F.V.L. (votre club) :
...
### Pour la délivrance d'une licence à un élève, le certificat médical présenté doit être de moins de :
...
### L'élève qui réussit son brevet de pilote fédéral :
...
### Les déclarations d'accident doivent être envoyées :
...
### La déclaration d'accident est nécessaire si :
...
### Lors d'un atterrissage en campagne, un pilote breveté, licencié, détruit le pare-brise d'une voiture; c'est :
...
### Vous vous posez en catastrophe dans un champ de blé non fauché :
...
### Le brevet de pilote et la qualification biplace sont certifiées par :
...
### Priorités en aéronefs non motorisés :
...
### Une aile arrive en face de vous, vous effectuez :
...
### La partie pratique du brevet de pilote est attribué par :
...
### En vol, un P.U.L. arrive sur votre droite avec une route convergente :
...
### Loin du relief, vous suivez la même route et au même niveau qu'une autre aile moins rapide ; vous effectuez le dépassement par :
...
### A niveau de vol égal, la priorité en vol revient :
...
### Vous êtes en vol de pente, le relief est à votre gauche. Une aile arrive en face à la même altitude :
...
### Deux ailes se suivent tout près d'un relief situé à leur droite, la deuxième aile est plus rapide :
...
### Vous êtes le premier à enrouler une ascendance :
...
### Vous voulez rentrer dans une ascendance alors qu'une autre aile spirale 50m en dessous :
...
### Le vol à l'intérieur des nuages est permis :
...
### A toute altitude dans les espaces aériens classés E et au dessus de 900 m mer ou 300 m sol en montagne dans les espaces aériens non contrôlés, la distance minimale à respecter par rapport aux nuages est de :
...
### Vous évoluez en vol de pente, dans un espace aérien non contrôlé, sur une montagne dont l'altitude est de 1000m. La base des nuages est à 1200m. Le respect des conditions de vol à vue vous permet de monter jusqu'à une altitude de :
...
### Dans un espace aérien non contrôlé et au dessous de 900 m mer ou 300 m sol en montagne, vous devez avoir :
...
### Une aile homologuée CEN est obligatoire
...
### Dans un espace aérien non contrôlé et au dessous de 900 m mer et 300 m sol en montagne, la visibilité minimale doit être de :
...
### Dans un espace aérien non contrôlé et au dessus de 900 m mer ou 300 m sol en montagne, vous devez avoir :
...
### Les règles de vol obligent chaque pilote :
...
### Un moniteur encadre un stage de formation en milieu aménagé (S.I.V., pilotage, acrobatie) dans le cadre d'une école fédérale :
...
### Pour décoller en sécurité, il est préférable de choisir une pente :
...
### La pente d'une aire de décollage doit être :
...
### Vous vous apprêtez à décoller à 15 heures sur un versant ensoleillé où s'est établi une légère brise montante. Le vent météo est nul :
...
### Une couche de stratus de 40m d'épaisseur est située sous le décollage :
...
### Par rapport au vent mesuré au décollage à 2m/sol, le vent 20m au dessus risque d'être :
...
### En haute montagne, la densité de l'air diminuant avec l'altitude et pour que votre aile puisse décoller, vous devez vous attendre à courir :
...
### Voler en local d'un atterrissage, c'est :
...
### Au cas où le vent météo change d'orientation ou d'intensité pendant le vol, il convient :
...
### Une aile vole face au vent; elle avance par rapport au sol ; le vent est :
...
### Vous volez vent arrière ; votre vitesse/air de croisière est égale à la vitesse du vent météo ; le sol :
...
### La vitesse de votre appareil par rapport au sol est :
...
### Lorsque vous volez vent arrière près du sol, l'impression visuelle tend à modifier votre perception de la vitesse/air, ce qui peut vous conduire à :
...
### Vous croisez une autre aile ; votre vitesse de croisement est égale à :
...
### En conditions turbulentes, il vaut mieux :
...
### En régime turbulent, il vaut mieux :
...
### Au cours d'un vol de pente en conditions relativement turbulentes :
...
### Vous rentrez dans un thermique et engagez un 360°. Après 90° de virage le variomètre devient négatif :
...
### Dans un thermique au cours des 360°, le variomètre passe par un maximum puis retombe à des valeurs faiblement positives :
...
### Lorsqu'un pilote exploite une bulle thermique pour gagner de l'altitude :
...
### Vous envisagez d'utiliser une ascendance où se trouve déjà un autre appareil ; vous :
...
### Vous approchez de la base d'un cumulus :
...
### En région montagneuse, vous recherchez de préférence les ascendances thermiques :
...
### Par une belle journée d'ascendances où des orages sont annoncés, il faut s'inquiéter si :
...
### Le passage d'un cumulonimbus dans votre secteur de vol :
...
### Faire une descente rapide en 360° enchaînés et serrés :
...
### Vous affrontez un vent de face de 15 km/h ; pour rentrer au terrain :
...
### Pour un pilote peu expérimenté, un terrain d'atterrissage se découvre :
...
### Vous vous dirigez vers le terrain en vent arrière à vitesse de croisière ; vous voyez les limites les plus rapprochées du terrain monter régulièrement vers vous :
...
### Vous êtes en approche ; une aile est juste en dessous de vous :
...
### Vous êtes en prise de terrain en S (P.T.S.) ; votre trajectoire s'enfonce sous le plan de descente prévu ; vous devez :
...
### Pour être précis à l'atterrissage, la visualisation correcte de la pente en finale est indispensable. Cette pente :
...
### Vous êtes en finale, face au terrain d'atterrissage ; vous vous apercevez que vous êtes un peu long et haut, vous risquez de dépasser le terrain ; vous choisissez :
...
### En finale, si la cible descend dans le champ de vision :
...
### Le freinage final par vent fort
...
### C’est mon premier vol de la saison
...
### Je me ferai probablement plus plaisir avec une aile
...
### Je m’approche de la base du nuage
...
### Au décollage, le vent est de travers 30°, 3m/s :
...
### Lors d'un gonflage par vent fort, la voile commence à vous tirer très fort vers l'arrière, vous risquez d'être traîné au sol :
...
### En vol, bras hauts, vos freins sont tendus et le bord de fuite est un peu abaissé :
...
### En turbulence vous faites les oreilles :
...
### A vitesse de taux de chute mini, pour amorcer un virage à droite sans trop perdre de vitesse et ne pas risquer la mise en vrille, vous devez :
...
### En vol, la diminution importante du vent relatif a pour conséquence :
...
### Vous volez au taux de chute minimum ; vous allez rentrer dans une ascendance :
...
### Pour rester dans une ascendance dynamique près du relief :
...
### En vol si vous ressentez des turbulences :
...
### En vol de pente une violente turbulence replie brutalement une demi-aile de votre parapente :
...
### Durant un vol de pente à 50m du sol, le sifflement du vent faiblit et votre aile s'enfonce en se trouvant proche de la vitesse de décrochage ; pour éviter le crash :
...
### Votre voile se replie brusquement côté relief :
...
### Vous êtes dos au relief et votre voile se ferme à 40% sur la gauche ce qui la met en virage à gauche :
...
### En vol turbulent, votre voile se ferme par devant sur une grande longueur du bord d'attaque :
...
### Votre demi aile gauche se ferme :
...
### Lors de la réception d'une aile neuve, vous devez :
...
### Vous êtes en finale face au terrain d'atterrissage ; vous vous apercevez que vous êtes un peu long et haut ; vous risquez de dépasser le terrain :
...
### A 4m/sol vous constatez que vous allez vous poser avec un vent de travers de 45° :
...
### En vol, le pilote peut anticiper :
...
### Le meilleur profil d'un terrain de décollage est :
...
### Vous gonflez symétriquement dos à l’aile avec un vent de travers droit
...
### Une fois que j'ai mis en œuvre les oreilles
...
### Par vent soutenu, préalablement à un gonflage face à l’aile
...
### En vol, la dureté de mes commandes
...
### Suite à une turbulence ou à une entrée de thermique mon aile cabre
...
### En vol une turbulence ferme brutalement mon aile ; je me sens tomber à droite dans ma sellette :
        ...
        - je regarde mon aile pour évaluer la situation et son évolution 2
    
        - j’actionne immédiatement ma main droite avec un geste ample et profond pour forcer la réouverture de l’aile -6
    
    
### A l’atterrissage une prise de vitesse est nécessaire en finale car :

    
        - en présence de vent le risque d’un gradient est propre à soudainement réduire ma vitesse relative 3
    
        - les forces aérodynamiques augmentant au carré de la vitesse, elles favoriseront un freinage efficace 3
    
        - les forces aérodynamiques n’ont pas une incidence directe sur la vitesse de vol -6
    
    
### Votre secours est ouvert, vous sentez la traction liée à son déploiement :

    
        - vous tirez sur un frein pour ramener la voile -6
    
        - vous tirez les élévateurs "B" pour stabiliser l'ensemble 2
    
        - vous regardez vers le bas pour estimer le lieux de l'atterrissage 2
    
        - vous vous redressez et vous préparez à amortir le choc 2
    
    
### Au décollage, il y a 30 km/h de vent ; mon aile vole à une vitesse maximum de 35 km/h :

    
        - vous devez courir à 5 km/h pour décoller -6
    
        - vous vous abstenez de décoller en estimant que la marge de sécurité n'est pas suffisante 6
    
        - vous utilisez l'accélérateur dés que possible pour pouvoir vous éloigner du relief -6
    
    
### Vous venez d'acquérir une nouvelle aile, afin de mieux la connaître et comme vous avez un parachute de secours :

    
        - vous recherchez la phase parachutale -6
    
        - vous multipliez les vols dans des aérologies standards pour vous la rendre familière 3
    
        - après un peu de gain, vous réalisez quelques "360°" engagés afin de mesurer le taux de chute maximal -6
    
        - vous effectuez éventuellement une journée de stage en milieu aménagé 3
    
    
### Au décollage, avec 20 km/h de face, vous pouvez gonfler votre voile :

    
        - dos à l'aile en vous préparant à mettre beaucoup d'énergie pour contrecarrer la force du vent -6
    
        - dos à l'aile en vous attendant à devoir résister en reculant pour contrôler la vitesse d'ascension du profil 3
    
        - face à l'aile en vous attendant à devoir résister en avançant pour contrôler la vitesse d'ascension du profil 3
    
        - face à l'aile en ordonnant à une aide extérieure de résister avec vous à la traction de votre voile -6
